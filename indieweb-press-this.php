...
class IndieWebPressThis {
   ...
   */
  function js() {
    wp_enqueue_script('indieweb-press-this', plugins_url( '/js/press_this.js' , __FILE__ ), false, '1.0', true);
  }
   ...
   */
  function generate_bookmarklet_js($type = "reply") {
